export const QuantityCounter = ({quantity, setQuantity, product, className}) => {
  ...
  return <div className={className}>
    <div className="flex justify-between bg-color rounded-3xl p-2 items-center">
      ...
      <div className="min-w-12 max-w-28 text-center bg-transparent flex items-center justify-center text-xl">{quantity ?? 0}</div>
